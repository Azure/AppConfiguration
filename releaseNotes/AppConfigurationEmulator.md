...
* Added multi-architecture container image support. The emulator image now includes both `linux/amd64` and `linux/arm64` variants, enabling it to run natively on ARM-based machines such as Apple silicon and Windows on ARM. [#74](https://github.com/Azure/AppConfiguration-Emulator/issues/74)

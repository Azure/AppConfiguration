...
* Added support for [TLS type Kubernetes Secret](https://kubernetes.io/docs/concepts/configuration/secret/#tls-secrets), which can be used to store a certificate and configure encryption in transit for an Ingress. [#821](https://github.com/Azure/AppConfiguration/issues/821)

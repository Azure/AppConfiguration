...
### Enhancements
* **Variant Feature Flags**: This is the first stable release with support for the `variants`, `allocation`, and `telemetry` properties for feature flags added by version 4 of the [Microsoft.FeatureManagement](https://github.com/microsoft/FeatureManagement-Dotnet) library. This enables [experimentation with Azure App Configuration](https://learn.microsoft.com/en-us/azure/azure-app-configuration/concept-experimentation), which opens up possibilities for improving user experience or software functionality using data from your feature flags.
